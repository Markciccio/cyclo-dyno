...
/** Nello Sprint conta il colpo massimo: il Best 5 s rimane una metrica utile,
 * ma non decide la classifica. */
export const leaderboardSort=<T extends {peakPower:number;timestamp:number}>(items:T[])=>[...items].sort((a,b)=>b.peakPower-a.peakPower||b.timestamp-a.timestamp)
