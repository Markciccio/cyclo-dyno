...
export interface DynoSession extends Metrics { id:string; participantName:string; riderWeightKg?:number; vehicle?:VehicleProfile; timestamp:number; sessionDuration:number; samples:SessionSample[]; dataSource:DataSource; validSession:boolean; quality:'VALID'|'INVALID'|'DEMO' }
