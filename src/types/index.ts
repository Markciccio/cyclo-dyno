...
/** Un giro chiuso su un anello, con le sue statistiche. */
export interface Lap { index:number; seconds:number; startMs:number; endMs:number; startKm:number; distanceKm:number; averageKmh:number; maxKmh:number; averageWatts:number; maxWatts:number }
